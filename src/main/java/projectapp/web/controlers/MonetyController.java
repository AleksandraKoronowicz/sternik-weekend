package projectapp.web.controlers;
...
import projectapp.services.KlaserService;
import projectapp.services.NotificationService;
...
public class MonetyController {
    ...
    public String showMainPages(final Moneta moneta) {
        ...
        moneta.setDataRealizacji(Calendar.getInstance().getTime());
        return "moneta";
    }
